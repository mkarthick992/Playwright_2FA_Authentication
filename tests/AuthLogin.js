...
test('Login to application with two factor authentication through microsoft azure directory', async ({ page }) => {
  ...
  await page.click("div.tile:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2)");
